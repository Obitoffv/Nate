...
async def vraid(c: MIKU, m: Message):
    ...
    if replied:
        if replied.video or replied.document:
            loser = await replied.reply(" **sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...**")
        ...
        if len(m.command) < 2:
            await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton(" sᴜᴘᴘᴏʀᴛ", url="https://t.me/Miku_updates"),
                            InlineKeyboardButton(" ᴜᴘᴅᴀᴛᴇs", url="https://t.me/Miku_updates")
                        ],
                        [
                            InlineKeyboardButton("• ᴄʟᴏsᴇ •", callback_data="cls")
...
async def raidlive(c: NIXA, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if len(m.command) == 2:
            ...
            Q = 720
            loser = await c.send_message(chat_id, "🔄 **ᴘʀᴏᴄᴇssɪɴɢ sᴛʀᴇᴀᴍ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...**")
            ...
            loser = await c.send_message(chat_id, "🔄 **ᴘʀᴏᴄᴇssɪɴɢ ʟɪᴠᴇʀᴀɪᴅ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ....**")
        else:
