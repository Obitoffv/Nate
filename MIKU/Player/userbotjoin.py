...
from MIKU.decorators import authorized_users_only, sudo_users_only, errors
...
@MIKU.on_message(command(["userbotleave",
...
@MIKU.on_message(command(["leaveall", f"leaveall@{BOT_USERNAME}"]))
@sudo_users_only
