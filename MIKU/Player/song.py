...
from MIKU.decorators import humanbytes
...
def song(_, message):
    ...
    m = message.reply("🔎 ғɪɴᴅɪɴɢ sᴏɴɢ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...")
    ...
    try:
        ...
        print(str(e))
        return
    m.edit("📥 ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ғɪʟᴇ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...")
    try:
...
async def vsong(client, message):
    ...
    try:
        ...
        print(e)
    try:
        msg = await message.reply("📥 **ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴠɪᴅᴇᴏ ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...**")
...
async def lyrics(_, message):
    try:
        ...
        rep = await message.reply_text("🔎 **sᴇᴀʀᴄʜɪɴɢ ʟʏʀɪᴄs ғᴏʀ ʏᴏᴜ ᴍᴏɪ ʟᴜʙ ❣️ ᴡᴀɪᴛ...**")
        resp = requests.get(
